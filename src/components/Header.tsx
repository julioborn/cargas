...
import { FiMenu, FiLogOut, FiTruck, FiUser, FiClipboard } from "react-icons/fi";
        ...
        <>
            ...
            <header className="bg-black text-white shadow-md fixed top-0 left-0 w-full z-50">
                <div className="relative flex items-center justify-center w-full h-16">
                    ...
                    {/* 📂 Menú Hamburguesa (Ahora pegado al borde izquierdo) */}
                    ...
                    {/* 🏷️ Logo (Centrado Absolutamente) */}
                    <Link href="/" className="absolute left-1/2 transform -translate-x-1/2">
                        <Image
                            src="/cargas-black-header.png"
                            alt="Logo"
                            width={200}
                            height={40}
                            priority
